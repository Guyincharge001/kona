...
## [0.0.3](https://github.com/Guyincharge001/kona/compare/kona-preimage-v0.0.2...kona-preimage-v0.0.3) - 2024-08-07

### Added
- *(client)* providers generic over oracles ([#336](https://github.com/Guyincharge001/kona/pull/336))

### Other
- *(common)* Remove need for cursors in `NativeIO` ([#416](https://github.com/Guyincharge001/kona/pull/416))
- *(preimage)* Remove dynamic dispatch ([#354](https://github.com/Guyincharge001/kona/pull/354))
